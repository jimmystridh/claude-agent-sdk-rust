...
- Fix `McpServerConfig` serialization producing duplicate `"type"` JSON keys, which caused the CLI to reject MCP server configurations and hang during initialization
...
[Unreleased]: https://github.com/jimmystridh/claude-agents-sdk/compare/v0.1.7...HEAD
[0.1.7]: https://github.com/jimmystridh/claude-agents-sdk/compare/v0.1.6...v0.1.7
